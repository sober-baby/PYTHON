...
// Configuration
// void askForConfig(int n, char board[][26], char colour) {
//   char input[2 + 1];
//   printf("Enter board configuration:");
//   do {
//     fgets(input, sizeof(input), stdin);
//     int row = inputConvert(input);
//     int col = inputConvert(input+1);
//     for (int i = 0; i < n; i++) {
//       if (i == row) {
//         for (int j = 0; j < n; j++) {
//           if (j == col) {
...
void userMove(char board[][26], int n, char colour, int *score, bool *end,
  ...
  if (availableMoves(board, n, colour)) {
    ...
    int row = inputConvert(&moveRow);
    int col = inputConvert(&moveCol);
